...
export const segments = 200;      // グリッドの分割数（解像度）
...
export const evaporation = 0.00005;       // フレームごとの水の蒸発量 (微量に設定)
...
export const configSourceEmission = { default: 0.5, min: 0.01, max: 5.0, step: 0.05 };
...
export const defaultSourceEmission = configSourceEmission.default;
